...
if __name__ == '__main__':
	...
	with open('sender_digital_keys','w') as file:
		pin = int(random.randint(1,128))

		pin = pin % 64
		
		privatekey = generate_private_key(pin)

		publickey=generate_public_key(privatekey)


		file.write('Private Key:  '+str(privatekey)+'\n')
		file.write('Public Key:  '+str(publickey))

	with open('reciever_digital_keys','w') as file:
